      ...
      <div className="flex justify-center items-center pt-28 pb-12 px-4">
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="text-center mb-8 animate-fadeIn">
            ...
            <h1 className="text-3xl font-bold text-slate-800 mb-2">GetMax Healthcare</h1>
            <p className="text-slate-600">Welcome back to your health journey</p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input type="checkbox" className="rounded border-slate-300 text-blue-600 focus:ring-blue-500 focus:ring-2" />
