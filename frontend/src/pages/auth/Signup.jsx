...
import { Mail, Lock, Eye, EyeOff, Shield, Heart, Activity, User, Phone, Calendar, MapPin, Users } from 'lucide-react';
...
const handleSubmit = async () => {
  ...
  const renderCompanyDetails = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
      ...
      <div className="group">
        <label htmlFor="jobTitle" className="block text-sm font-medium text-slate-700 mb-2">Job Title</label>
        <div className="relative">
      ...
      <div className="group">
        <label htmlFor="industryType" className="block text-sm font-medium text-slate-700 mb-2">Industry Type</label>
        <div className="relative">
  ...
  const isStepValid = () => {
    if (currentStep === 1) {
      ...
      return formData.companyName && formData.jobTitle && formData.country && formData.industryType;
      ...
      <main className="relative z-10 pt-20 pb-16 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8 animate-fadeIn">
            ...
            <h1 className="text-3xl font-bold text-slate-800 mb-2">Join GetMax Healthcare</h1>
            <p className="text-slate-600">Start your journey to better health today</p>
          </div>
                ...
                <div key={step} className="flex items-center">
                  ...
                  {step < 3 && (
                    <div className={`w-12 h-1 mx-2 rounded-full transition-all duration-200 ${
                      currentStep > step ? 'bg-gradient-to-r from-blue-600 to-teal-600' : 'bg-slate-200'
                    }`}></div>
                  )}
                </div>
            ))}
          ...
          <div className="flex justify-center mt-2 space-x-8">
            <span className={`text-xs font-medium ${currentStep >= 1 ? 'text-blue-600' : 'text-slate-400'}`}>
              Personal Info
            </span>
            <span className={`text-xs font-medium ${currentStep >= 2 ? 'text-blue-600' : 'text-slate-400'}`}>
              Details
            </span>
            <span className={`text-xs font-medium ${currentStep >= 3 ? 'text-blue-600' : 'text-slate-400'}`}>
              Security
            </span>
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-white/20 animate-slideUp">
         ...
         {currentStep === 2 && (
  <div className="space-y-6">
    <h2 className="text-xl font-semibold text-slate-800 mb-4">Company & Business Information</h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="group">
        <label htmlFor="monthlyClaimsVolume" className="block text-sm font-medium text-slate-700 mb-2">
          Monthly Claims Volume
        </label>
        <input
          type="text"
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {/* Current EHR */}
      <div className="group">
        <label htmlFor="currentEHR" className="block text-sm font-medium text-slate-700 mb-2">
          Current EHR
        </label>
        <input
          type="text"
    ...
    <div className="group">
      ...
      />
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <h2 className="text-xl font-semibold text-slate-800 mb-4">Security & Agreement</h2>
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-start">
                  ...
                  />
                  <span className="ml-3 text-sm text-slate-600">
                    I would like to receive email notifications about appointments and health tips
                  </span>
                </label>
              </div>
            </div>
